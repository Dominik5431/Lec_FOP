...
public class ScoreEntry implements Comparable<ScoreEntry> {
	...
	public static ScoreEntry read(String line) {
		...
		//Überprüft auf korrekte Eingabe -> ob alle drei benötigten Elemente vorhanden sind
		if (result.length != 3)
			return null;
		//Erzeug neues ScoreEntry Objekt
		return new ScoreEntry(result[0], LocalDateTime.parse(result[1]), Integer.parseInt(result[2]));
	}
	...
	public void write(PrintWriter printWriter) {
		// TODO Aufgabe 4.2.1
		String result = this.name + ";" + dateTime.toString() + ";" + this.score;
